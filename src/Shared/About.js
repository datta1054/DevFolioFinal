  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.text}>
        At CalmSoul, we are dedicated to providing high-quality
        psychiatric therapy services to individuals seeking support and
        guidance. Our team of experienced and compassionate psychiatrists is
        committed to helping you improve your mental well-being and lead a
        fulfilling life.
      </p>
      <img
      ...
      <h2>Our Approach</h2>
      <p className={styles.text}>
        At CalmSoul, we believe in a holistic approach to mental
        health. We understand that each individual is unique, and we strive to
        provide personalized treatment plans tailored to your specific needs.
        Our psychiatrists employ a range of therapeutic techniques, including
